        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end mu-bg" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action mu-bg 
                        text-light p-3" href="department.php"><b>Departments</b></a> 
                    <a class="list-group-item list-group-item-action mu-bg 
                        text-light p-3" href="work_title.php"><b>Work Title</b></a>
                    <a class="list-group-item list-group-item-action mu-bg 
                        text-light p-3" href="leave_type.php"><b>Leave Type</b></a>           
                    <a class="list-group-item list-group-item-action mu-bg 
                        text-light p-3" href="manage_employee.php"><b>Manage emloyee</b></a>               
                    <a class="list-group-item list-group-item-action mu-bg 
                            ...
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                <li class="nav-item active">
                                    <a class="nav-link" href="#!">
                                        <img src="<?php echo $_SESSION['admin_detail']['passport'];  ?>" width="50px" height="50px" style="border-radius: 100%;"> <b>
                                        <?php echo $_SESSION['admin_detail']['first_name'];?>
                                        </b></a></li>
                            </ul>
                        </div>
                    </div>
