...
<?php if(!isset($_SESSION['hr_loged_in'])): ?>
    <?php header('location:../logout.php') ?>
<?php endif ?>

<?php $user_id = $_SESSION['hr_detail']['user_id'];?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end mu-bg" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action mu-bg 
                        text-light p-3" href="applied_leave.php"><b>Applied Leave</b></a>
                                            <a class="list-group-item list-group-item-action mu-bg 
                        text-light p-3" href="assign_salary.php"><b>Assign Salary</b></a> 
                    <a class="list-group-item list-group-item-action mu-bg 
                            ...
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                <li class="nav-item active">
                                    <a class="nav-link" href="#!">
                                        Welcome <b>
                                        <?php echo $_SESSION['hr_detail']['first_name'];?>
                                        </b></a></li>
                            </ul>
                        </div>
                    </div>
