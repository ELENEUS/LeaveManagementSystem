...
<?php $user_id = $_SESSION['accountant_detail']['user_id'];?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
        ...
        <title>Human resource | Panel</title>
        <!-- Favicon-->
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end mu-bg" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action mu-bg 
                        text-light p-3" href="set_salary.php"><b>Set Salary</b></a>
                    <a class="list-group-item list-group-item-action mu-bg 
                        text-light p-3" href="pay_salary.php"><b>Pay Salary</b></a>
                    <a class="list-group-item list-group-item-action mu-bg 
                        text-light p-3" href="set_income_and_expences.php"><b>Set Income and Expences</b></a> 
                    <a class="list-group-item list-group-item-action mu-bg 
                            ...
                            <ul class="navbar-nav ms-auto mt-2 mt-lg-0">
                                <li class="nav-item active">
                                    <a class="nav-link" href="#!">
                                        Welcome <b>
                                        <?php echo $_SESSION['accountant_detail']['first_name'];?>
                                        </b></a></li>
                            </ul>
                        </div>
                    </div>
